...
1. **Hero-Porträt-Parallaxe** (`[data-parallax-bg]`, Attribut `data-parallax-bg="1.1"`, `data-bg-base="14"`):
...
| --- | --- | --- |
| `assets/joerg-schleburg.png` | vom Kunden geliefert | Porträt-Füllung der Hero-Headline, `background-position:50% 14%` |
